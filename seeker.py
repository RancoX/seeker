...
from seek_crawler import Path, BASE_DIR, main, headers, API_URL, classifications

subcategories = [*classifications.keys()]
...
class MyMainWindow(QMainWindow):
    def __init__(self):
        ...
        # meta set up
        self.setWindowTitle('Seeker v5.0')
    ...
    def show_about_info(self):
        ...
        about_info = '''
            ...
            ## Update log - v3.0
            @ 2024-05-31 Brissy AU
            Fixed the issue when available pages to parse is less than user defined pages, unrelated job positions are collected

            ## Update log - v4.0
            @ 2024-06-17 Brissy AU
            Fixed the bug that maxPage overrides user defined pages so only 66 results are parsed each time

            ## Update log - v5.0
            @ 2024-07-31 Brissy AU
            New seek.com.au api endpoint found so replaced previous html scraping which improves efficiency a lot
        '''
...
# pyinstaller --noconsole --icon="C:\Users\RancoXu\ArgyleLaptop\Ranco\Python\Seeker\data\icon.png" --noconfirm "C:\Users\RancoXu\ArgyleLaptop\Ranco\Python\Seeker\seeker.py" --paths "C:\Users\RancoXu\ArgyleLaptop\Ranco\Python\Seeker\venv_seeker\Lib\site-packages"  --add-data 'seek_crawler.py;.' --add-data 'data\folder.png;.\data' --add-data 'data\args.json;.\data'